...
int main(void)
{
  ...
  while (1)
  {
    ...
    setDigital(B, lockPin, nightMode);

  // reading is between 0 and 1023, dividing by 4 makes it be between 0 and 255
    //setAnalog(outsideReading/4);
...
void setWindowPosition(int insideReading, int outsideReading, int lightReading, bool nightMode)
{
  ...
  if (lightReading > BRIGHT_LIGHT_LEVEL)
  {
